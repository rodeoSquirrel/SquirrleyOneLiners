...
Compress a directory and it's contents/subdirectories including the target root directory
```
Compress-Archive -Path 'C:\Users\susUser\AppData\local\Google\Chrome\User Data\Default\' -DestinationPath C:\windows\temp\sus-chrome-profile.zip
```
